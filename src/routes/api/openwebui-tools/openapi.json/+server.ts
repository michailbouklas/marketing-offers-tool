...
const TOOL_DESCRIPTION = [
  ...
  "whenever the user asks anything about sales figures or trends, AND for",
  "questions about the user's own data access — e.g. 'which brands am I",
  "assigned to', 'what sales data can I see', 'what can I ask you about' —",
  "which it answers from the user's brand assignments without running a",
  "query. Pass the question verbatim, including any dates, periods, brands,",
  "stores or comparisons they mentioned; for follow-ups also pass the",
  "relevant earlier turns in conversation_context. The answer is",
  "authoritative — computed from the data warehouse and already restricted",
  "to the brands the calling user is assigned to (also listed in",
  "brands_in_scope). Present its figures as-is; never recompute, estimate or",
  "invent numbers, and never guess a user's brand list yourself. Do not use",
  "this tool for topics unrelated to PHC sales data.",
].join(" ");
