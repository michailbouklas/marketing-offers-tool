...
This project is indexed by GitNexus as **marketing-offers-tool** (2419 symbols, 4072 relationships, 187 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Server area (85 symbols)           | `.claude/skills/generated/server/SKILL.md`                  |
| Work in the Image-providers area (33 symbols)  | `.claude/skills/generated/image-providers/SKILL.md`         |
| Work in the Image-generator area (30 symbols)  | `.claude/skills/generated/image-generator/SKILL.md`         |
