...
- **`load`** (Function) — `src/routes/competition/offers/+page.server.ts:65`
...
| `exclusiveUpperBound`    | Function | `src/routes/competition/offers/+page.server.ts`        | 58   |
