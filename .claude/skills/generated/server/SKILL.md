---
name: server
description: "Skill for the Server area of marketing-offers-tool. 143 symbols across 43 files."
---

# Server

143 symbols | 43 files | Cohesion: 70%
...
| `src/lib/server/auth-guards.ts`                            | requireAuthenticatedApiUser, hasSuperUserRole, getAuthenticatedUserRole, isPublicPath, isApiPath (+2) |
