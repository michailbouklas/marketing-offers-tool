---
name: server
description: "Skill for the Server area of marketing-offers-tool. 73 symbols across 22 files."
---

# Server

73 symbols | 22 files | Cohesion: 80%
...
| File                                                  | Symbols                                                                                              |
| ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `src/lib/server/brand-storage.ts`                     | ensureSafeSlug, brandDir, brandGuidelinesPath, ensureBrandDir, writeBrandGuidelines (+6)             |
