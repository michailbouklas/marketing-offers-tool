---
name: server
description: "Skill for the Server area of marketing-offers-tool. 149 symbols across 46 files."
---

# Server

149 symbols | 46 files | Cohesion: 71%
...
| File                                                       | Symbols                                                                                                                     |
| ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `src/lib/server/object-store.server.ts`                    | getText, putText, list, assertSafeKey, toPath (+23)                                                                         |
...
| `src/lib/server/auth-guards.ts`                            | isPublicPath, isApiPath, isAdminPath, requireAdminSection, hasPermission (+3)                                               |
...
| `src/lib/server/scraper-db.ts`                             | getConnectionString, getScraperPool, readQueueBatch, readPendingQueueRowsForEntities, countPendingQueueRowsForEntities (+1) |
