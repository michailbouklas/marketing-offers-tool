...
33 symbols | 9 files | Cohesion: 85%
...
| File                                                     | Symbols                                                                                                   |
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `src/lib/services/image-providers/enhance.server.ts`     | PromptEnhancerError, PromptEnhancer, enhance, enhanceWithClarifications, callChatCompletion (+3)          |
...
| `enhance`                   | Method    | `src/lib/services/image-providers/enhance.server.ts`     | 117  |
| `enhanceWithClarifications` | Method    | `src/lib/services/image-providers/enhance.server.ts`     | 134  |
...
| `POST → FetchFn`                      | intra_community | 5     |
| `POST → SafeJson`                     | intra_community | 5     |
| `POST → PromptEnhancerError`          | intra_community | 5     |
| `POST → NormalizeClarifyingQuestions` | intra_community | 5     |
