...
This project is indexed by GitNexus as **marketing-offers-tool** (4116 symbols, 7476 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Server area (156 symbols) | `.claude/skills/generated/server/SKILL.md` |
| Work in the Services area (147 symbols) | `.claude/skills/generated/services/SKILL.md` |
| Work in the Image-generator area (80 symbols) | `.claude/skills/generated/image-generator/SKILL.md` |
| Work in the Image-providers area (53 symbols) | `.claude/skills/generated/image-providers/SKILL.md` |
| Work in the Competition area (35 symbols) | `.claude/skills/generated/competition/SKILL.md` |
| Work in the Google-reviews area (28 symbols) | `.claude/skills/generated/google-reviews/SKILL.md` |
| Work in the Notifications area (25 symbols) | `.claude/skills/generated/notifications/SKILL.md` |
| Work in the Restaurants area (17 symbols) | `.claude/skills/generated/restaurants/SKILL.md` |
...
| Work in the Brand-context area (12 symbols) | `.claude/skills/generated/brand-context/SKILL.md` |
| Work in the Text-providers area (10 symbols) | `.claude/skills/generated/text-providers/SKILL.md` |
| Work in the Guidelines area (9 symbols) | `.claude/skills/generated/guidelines/SKILL.md` |
| Work in the Offers area (7 symbols) | `.claude/skills/generated/offers/SKILL.md` |
| Work in the Inspiration area (6 symbols) | `.claude/skills/generated/inspiration/SKILL.md` |
