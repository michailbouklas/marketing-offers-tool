...
This project is indexed by GitNexus as **marketing-offers-tool** (2464 symbols, 4165 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Server area (76 symbols)           | `.claude/skills/generated/server/SKILL.md`                  |
...
| Work in the Users area (8 symbols)             | `.claude/skills/generated/users/SKILL.md`                   |
